		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Alex App 1",
									"targetURL": "#atclouddnatraining01zalexapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnatraining01zalexapp1-display": {
								"semanticObject": "atclouddnatraining01zalexapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.training01.zalexapp1",
									"url": sap.ui.require.toUrl("at/clouddna/training01/zalexapp1")
								}
							}
						}
					}
